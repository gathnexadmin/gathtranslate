import concurrent.futures, requests, re, os, html, urllib.parse

class GoogleTranslater:

    def __init__(self, source_language='auto', target_language='ta', timeout=5):
    ...
    def get_request(self, text):
        ...
        url = 'https://translate.google.com/m?tl=%s&sl=%s&q=%s'%(self.target_language, self.source_language, escaped_text)
